...
The 'duration_prediction' project was generated by using the default-python template.

The Asset Bundle was generated with:
```
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] duration_prediction_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/duration_prediction.job.yml). The schedule
